...
SCRIPT_NAME="DEPNotify App Install Helper"
SCRIPTVER="1.10.2"

# Note: For Parameter $7 
# The package size must be specified so the progress bar on the install screen is accurate.
# To get the package size run this in Terminal: 
# ls -l <pathtopkg> | awk '{ print $5 }' | awk '{$1/=1024;printf "%.i\n",$1}'
...
INSTALL_ICON="/System/Library/CoreServices/Installer.app/Contents/Resources/AppIcon.icns"
DN_TITLE="$APPNAME Install Helper"
DOWNLOAD_DESC="Your Mac is currently downloading $APPNAME. This process will take a long time, depending on your internet connection. Please be patient.\n\n You can continue to use your Mac while this continues to download. Do not close your MacBook screen.\n\nIf you want to cancel this process press CTRL+CMD+C."
INSTALL_DESC="Your Mac is now installing $APPNAME. This process will take a long time. Please be patient.\n\n You can still continue to use your Mac while this installs. Do not close your MacBook screen.\n\nIf you want to cancel this process press CTRL+CMD+C."
IT_SUPPORT="Service Now"
...
# Error dialogs
FREESPACE_ERROR="There is not enough space on your Mac to complete this install. You need to have at least ${min_drive_space} GB available."
DL_ERROR="There was a problem with your internet connection, the download has failed, this process will now quit. Please try again or open a ticket with $IT_SUPPORT."
INSTALL_ERROR="The app installation failed. Please open a ticket with $IT_SUPPORT."
...
dep_notify() {
    ...
    /usr/bin/defaults write "$DNPLIST" helpBubble -array "About" \
    "The progress bar will update based on your current download and install size. \n\nIf you have issues, please contact $IT_SUPPORT."
