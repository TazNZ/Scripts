...
/usr/bin/logger "Starting Office for Mac License Removal 2.1"
...
/usr/bin/sudo -u $USER /usr/bin/pkill -HUP "Microsoft Word"
/usr/bin/sudo -u $USER /usr/bin/pkill -HUP "Microsoft Excel"
/usr/bin/sudo -u $USER /usr/bin/pkill -HUP "Microsoft PowerPoint"
/usr/bin/sudo -u $USER /usr/bin/pkill -HUP "Microsoft Outlook"
/usr/bin/sudo -u $USER /usr/bin/pkill -HUP "Microsoft OneNote"
...
if [ -f "$O365SUBMAIN" ] || [ -f "$O365SUBBAK1" ] || [ -f "$O365SUBBAK2" ] || [ -f "$O365SUBMAINB" ] || [ -f "$O365SUBBAK1B" ] || [ -f "$O365SUBBAK2B" ] || [ -f "$VNEXTLICENSEPATH" ]
then
	...
	/usr/bin/sudo -u $USER rm -f "$VNEXTLICENSEPATH"
...
/usr/bin/sudo -u $USER /usr/bin/security delete-generic-password -G 'MSOpenTech.ADAL.1'
/usr/bin/sudo -u $USER /usr/bin/security delete-generic-password -l 'com.helpshift.data_com.microsoft.Outlook'
/usr/bin/sudo -u $USER /usr/bin/security delete-generic-password -l 'com.helpshift.data_com.microsoft.Outlook'
/usr/bin/sudo -u $USER /usr/bin/security delete-generic-password -l 'com.helpshift.data_com.microsoft.Outlook'
/usr/bin/sudo -u $USER /usr/bin/security delete-generic-password -l 'com.helpshift.data_com.microsoft.Outlook'
/usr/bin/sudo -u $USER /usr/bin/security delete-generic-password -l 'MicrosoftOfficeRMSCredential'
...
/usr/bin/sudo -u $USER /usr/bin/defaults write com.microsoft.office OfficeAutoSignIn -bool TRUE
...
/usr/bin/logger "Completed Office for Mac License Removal 2.1"
